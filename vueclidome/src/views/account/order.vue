				...
				<div class="js-list-inner">
					<div class="box-inner order-cart order-list-cart clear" v-for="(order,index) in orderData">
						<div class="gray-sub-title cart-title">
							...
							<span class="order-detail"><router-link :to="{path:'/paryment', query: {orderId: order.orderId}}">查看详情&gt;</router-link></span> 
								...
								<div class="prod-info clear">
									...
									<div class="items-params clear">
										<div class="name vh-center">
											<a href="javascript:;" target="_blank">{{item.title}}（{{item.spec_json.show_name}}）</a>
										</div>
						...
						<div class="prod-operation">
							...
							<div class="status">
								<router-link :to="{path:'/paryment', query: {orderId: order.orderId}}" class="blue-small-btn js-payment-order" v-if="!order.isPay">现在付款</router-link>
