		...
		<div class="item-box">
			<div class="gallery-wrapper">
				<div class="gallery">
					<div class="thumbnail">
						<ul>
							<li 
                                ...
                                v-for="(item,index) in itemsInfo.ali_images" 
                                key="index"
					...
					<div class="thumb">
						<ul>
							<li :class="{'on':index==imgIndex}" v-for="(item,index) in itemsInfo.ali_images" key="index">
					...
					<div class="sku-dynamic-params clear">
						...
						<ul class="params-colors">
							<li :class="{'cur':color.id==$route.query.itemId}" v-for="color,index in itemsInfo.sku_list">
                                <router-link
                                    :title="color.color"
                                    :to="{ path:'/item', query:{itemId:color.id} }"
					...
					<div class="sku-dynamic-params clear">
						...
						<div class="params-detail clear">
							<div class="item-num js-select-quantity">
								<span class="down" :class="{'down-disabled':count<=1}" @click="delCount">-</span>
				...
				<div class="sku-status">
					<div class="cart-operation-wrapper clearfix">
						<span class="blue-title-btn js-add-cart" 
                            @click="addCarPanelHandle(itemsInfo)"
                        >
                            <a>加入购物车</a>
                        </span>
                        <router-link class="gray-title-btn" :to="{path:'/checkout'}" tag="span"><a>现在购买</a></router-link>
					</div>
				</div>
			</div>
		</div>
...
export default {
    ...
    methods: {
        ...
        /*...mapMutations({
          addCarPanelHandle: 'addCarPanelData'
        }),*/
        addCarPanelHandle (data) {
            let itemData = {info: data, count: this.count}
